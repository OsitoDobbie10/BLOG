...
let setMaxBounds= [14.0758, -87.1826, 14.1075, -87.1418]; 
//crear nuesttro mapa 
let mapa = L.map('map5',mapoptions1,setMaxBounds);
...
let terreno = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
    maxZoom: 16,
...
function popup(feature,layer){
    ...
    let style3 = {fillColor:'white',
    weight: 2,
    color:'yellow',
    fillOpacity: 0.7};  

    let curvas1 = L.geoJson(curvas,{style:style3,
...
L.control.layers(baseMaps,capas,{position: "topleft"}).addTo(mapa); 
...
var minimap = new L.Control.MiniMap(carto_light,
    ...
    const legend3 = new L.control.Legend({ 
        position: "bottomleft",
        collapsed: false,
        symbolWidth: 24,
        opacity:0,
        ...
        legends: [
            ...
            inactive: false,},
            {label: "Cuenca declarada.", 
            type: "polygon",
            color: "#ffff",
            fillColor: "#ffff00",
            weight: 2,
            sides: 4,
            layers: cuenca_declarada1,
            inactive: false,},
            {label: "Rios cuenca.", 
            type: "polyline",
            color: "#ffff",
