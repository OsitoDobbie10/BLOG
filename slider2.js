...
let slidersection = document.querySelectorAll(".slider_section2");
...
const btnright = document.querySelector("#btn--right2") ;
...
function next(){
    ...
    let slidersectionfirst = document.querySelectorAll(".slider_section2")[0];
